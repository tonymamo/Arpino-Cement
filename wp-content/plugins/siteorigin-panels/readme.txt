...
2. Read the [usage documentation](https://siteorigin.com/page-builder/documentation/) on SiteOrigin.
...
Page Builder is actively developed and updated, so generally; we recommend that you have your users install the original plugin so they can receive updates. You can try [TGM Plugin Activation](https://tgmpluginactivation.com/).

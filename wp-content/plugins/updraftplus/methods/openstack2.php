...
class UpdraftPlus_BackupModule_openstack extends UpdraftPlus_BackupModule_openstack_base {
	...
	public function get_configuration_middlesection_template() {
		...
		<tr class="<?php echo $classes; ?>">
			<th><a href="https://docs.openstack.org/openstack-ops/content/projects_users.html" title="<?php _e('Follow this link for more information', 'updraftplus');?>" target="_blank"><?php _e('Tenant', 'updraftplus');?></a>:</th>

 ...
 *   #       cURL's web site (https://curl.haxx.se).  To use the newer CA bundle,
...
class UpdraftPlus_CF_Authentication
{
     ...
     * directly from cURL's web site (https://curl.haxx.se).  You can direct
...
class UpdraftPlus_CF_Container
{
     ...
     *
     * # Enable Referrer
     * $public_container->acl_referrer("https://www.example.com/gallery.php");
     * </code>
     *
     * @returns boolean True if successful
     * @throws CDNNotEnabledException CDN functionality not returned during auth

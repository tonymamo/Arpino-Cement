...
class Url
{
     ...
     *                              on strict RFC 3986 section 5.4.1. This means that "https://a.com/foo/baz" merged with
     *                              "bar" would become "https://a.com/foo/bar". When this value is set to false, it would
     *                              become "https://a.com/foo/baz/bar".
     * @return Url
     * @throws InvalidArgumentException

...
class CookieParser implements CookieParserInterface
{
    ...
    public function parseCookie($cookie, $host = null, $path = null, $decode = false)
    {
        ...
        // Check path attribute according RFC6265 https://tools.ietf.org/search/rfc6265#section-5.2.4
     ...
     * https://tools.ietf.org/search/rfc6265#section-5.1.4 Paths and Path-Match
     *

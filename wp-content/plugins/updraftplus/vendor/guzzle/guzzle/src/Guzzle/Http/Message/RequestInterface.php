...
interface RequestInterface extends MessageInterface, HasDispatcherInterface
{
    ...
    /**
     * Get the full URL of the request (e.g. 'https://www.guzzle-project.com/')
     *
     ...
     * @link https://php.net/manual/en/function.curl-setopt.php See the available options for CURLOPT_HTTPAUTH

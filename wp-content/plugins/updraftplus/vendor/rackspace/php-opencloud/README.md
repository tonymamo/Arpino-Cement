...
Our official documentation is now available on https://docs.php-opencloud.com. For SDKs in different languages, see https://developer.rackspace.com.
...
**Note**: Since PHP 5.3 has reached [end of life](https://php.net/eol.php) and is no longer officially supported, we are moving to 5.4 as a minimum requirement. If upgrading is not an option and you still need a stable version of the SDK for 5.3, please follow [this guide](https://docs.php-opencloud.com/en/latest/using-php-5.3.html).

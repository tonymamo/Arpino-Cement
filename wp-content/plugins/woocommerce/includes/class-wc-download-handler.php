...
class WC_Download_Handler {
	...
	protected static function get_download_range( $file_size ) {
		...
		if ( isset( $_SERVER['HTTP_RANGE'] ) ) { // @codingStandardsIgnoreLine.
			...
			/*
			 * Check the range and make sure it's treated according to the specs: https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html.
	 ...
	 * Read file chunked.
	 *
	 * Reads file in chunks so big downloads are possible without changing PHP.INI - https://codeigniter.com/wiki/Download_helper_for_large_files/.
	 *

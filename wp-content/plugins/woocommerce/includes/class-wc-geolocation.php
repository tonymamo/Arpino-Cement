...
class WC_Geolocation {
	 ...
	 * @deprecated 3.4.0
	 */
	const GEOLITE_DB = 'https://geolite.maxmind.com/download/geoip/database/GeoLiteCountry/GeoIP.dat.gz';
	 ...
	 * @deprecated 3.4.0
	 */
	const GEOLITE_IPV6_DB = 'https://geolite.maxmind.com/download/geoip/database/GeoIPv6.dat.gz';
	 ...
	 * @deprecated 3.9.0
	 */
	const GEOLITE2_DB = 'https://geolite.maxmind.com/download/geoip/database/GeoLite2-Country.tar.gz';
	...
	private static $geoip_apis = array(
		...
		'ip-api.com' => 'https://ip-api.com/json/%s',
	);

...
class WC_API_Authentication {
	...
	/**
	 * Perform OAuth 1.0a "one-legged" (https://oauthbible.com/#oauth-10a-one-legged) authentication for non-SSL requests
	 *
	 ...
	 *
	 * @link https://tools.ietf.org/html/rfc5849 for the full spec
	 * @since 2.1
	 * @return array
	 * @throws Exception
	 */

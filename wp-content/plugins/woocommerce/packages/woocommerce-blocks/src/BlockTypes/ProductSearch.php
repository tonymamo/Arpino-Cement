	...
	protected function render( $attributes, $content ) {
		...
		$button_markup = sprintf(
			'<button type="submit" class="wc-block-product-search__button" aria-label="%s">
				<svg aria-hidden="true" role="img" focusable="false" class="dashicon dashicons-arrow-right-alt2" xmlns="https://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">

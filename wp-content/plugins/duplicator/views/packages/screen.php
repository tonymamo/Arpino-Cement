...
class DUP_Package_Screen extends DUP_UI_Screen
{
	...
	public function get_step3_help()
	{
		return __("<b>Packages » 3 Build</b> <br/>"
				...
				. "your host's webroot accessible from a valid URL such as https://your-domain/your-wp-directory/installer.php to launch the install wizard. On some hosts the root directory "

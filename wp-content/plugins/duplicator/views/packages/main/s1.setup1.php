            ...
            <div class='dup-sys-req'>
                ...
                <div class="dup-sys-info dup-info-box">
                    <table class="dup-sys-info-results">
                        ...
                        <tr>
                            <td><?php esc_html_e('Function', 'duplicator'); ?> <a href="https://php.net/manual/en/function.file-get-contents.php" target="_blank">file_get_contents</a></td>
                            <td><?php echo esc_html($dup_tests['PHP']['FUNC_1']); ?></td>
                            <td><?php echo ''; ?></td>
                        </tr>					
                        <tr>
                            <td><?php esc_html_e('Function', 'duplicator'); ?> <a href="https://php.net/manual/en/function.file-put-contents.php" target="_blank">file_put_contents</a></td>
                            <td><?php echo esc_html($dup_tests['PHP']['FUNC_2']); ?></td>
                            <td><?php echo ''; ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e('Function', 'duplicator'); ?> <a href="https://php.net/manual/en/mbstring.installation.php" target="_blank">mb_strlen</a></td>
            ...
            <div class='dup-sys-req'>
                ...
                <div class="dup-sys-info dup-info-box">
                    ...
                    <small>
                        ...
                        echo "&nbsp;<i><a href='https://php.net/manual/en/mysqli.installation.php' target='_blank'>[" . esc_html__('more info', 'duplicator') . "]</a></i>";
                        ?>										
                    </small>
                    <hr>
                    <table class="dup-sys-info-results">

	...
	<div class="scan-item scan-item-last">
		...
		<div class="info">
			...
			<?php
				...
				echo '<br/><br/>';
				$lnk = '<a href="https://dev.mysql.com/doc/refman/5.7/en/server-system-variables.html#sysvar_lower_case_table_names" target="_blank">' . esc_html__('lower_case_table_names', 'duplicator') . '</a>';

...
class DUPX_U
{
     ...
     * 2) wrong protocol new url to right protocol new url (es. https://www.new.url => https://www.new.url)
     *
     * @param string $old
     * @param string $new
     */
    public static function replacmentUrlOldToNew($old, $new)
    {
        ...
        $url_old_raw = str_ireplace(array('https://', 'https://'), '//', $old);
        $url_new_raw = str_ireplace(array('https://', 'https://'), '//', $new);

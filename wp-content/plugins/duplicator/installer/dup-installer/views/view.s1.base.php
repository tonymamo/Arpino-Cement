    ...
    <div id="s1-area-sys-setup" style="display:none" class="hdr-sub1-area">
        ...
        <div class="s1-reqs" id="s1-reqs-all">
            ...
            <div class="info" id="s1-reqs10">
                ...
                PHP with <a href='https://php.net/manual/en/features.safe-mode.php' target='_blank'>safe mode</a> should be disabled.  If Safe Mode is enabled then
            ...
            <div class="info" id="s1-reqs20">
                Support for the PHP <a href='https://us2.php.net/manual/en/mysqli.installation.php' target='_blank'>mysqli extension</a> is required.
        ...
        <div class="s1-reqs" id="s1-notice-all">
            ...
            <div class="info" id="s1-notice50">
                ...
                If <a href="https://php.net/manual/en/ini.core.php#ini.open-basedir" target="_blank">open_basedir</a> is enabled and your
            ...
            <div class="info" id="s1-notice60">
                ...
                The PHP <a href="https://php.net/manual/en/info.configuration.php#ini.max-execution-time" target="_blank">max_execution_time</a> setting is used to
                ...
                <a href="https://php.net/manual/en/function.set-time-limit.php" target="_blank">set_time_limit</a> setting.   If this notice shows as a warning then it is

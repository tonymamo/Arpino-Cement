	...
	<div class="s2-reqs" id="s2-notices-all">
		...
		<div class="info" id="s2-notice10">
			...
			<ul>
				...
				<li><i class="fa fa-external-link"></i> <a href='https://www.inmotionhosting.com/support/website/general-server-setup/edit-mysql-my-cnf' target='_help'>How to edit MySQL config files my.cnf (linux) or my.ini (windows) files</a></li>
			</ul>
		</div>

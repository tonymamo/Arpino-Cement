            ...
            <table class="help-opt">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        This extraction method will use the PHP <a href="https://php.net/manual/en/book.zip.php" target="_blank">ZipArchive</a> code to extract the archive zip file.
                        <br/><br/>

                        <b>Shell-Exec Unzip</b><br/>
                        This extraction method will use the PHP <a href="https://php.net/manual/en/function.shell-exec.php" target="_blank">shell_exec</a> to call the system unzip
                ...
                <tr>
                    ...
                    <td>
                        <b>All Files:</b> Check the 'All Files' check-box and enter in the desired <a href="https://php.net/manual/en/function.chmod.php" target="_blank">chmod command</a>
                        ...
                        <b>All Directories:</b> Check the 'All Directories' check-box and enter in the desired <a href="https://php.net/manual/en/function.chmod.php" target="_blank">chmod command</a>
...
<section id="<?php echo $sectionId; ?>" class="expandable <?php echo $expandClass; ?>" >
    ...
    <div class="content" >
        ...
        <div id="dup-help-step1" class="help-page">
            ...
            will require that the database be setup ahead of time.  The cPanel option is for hosts that support <a href="https://cpanel.com/" target="_blank">cPanel Software</a>.
            ...
            <table class="help-opt">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        - Your host does not use <a href="https://cpanel.com/" target="_blank">cPanel Software</a> <br/>
        ...
        <div id="dup-help-step2" class="help-page">
            ...
            <table class="help-opt">
                ...
                <tr>
                    ...
                    <td> For details see WordPress <a href="https://codex.wordpress.org/Changing_The_Site_URL" target="_blank">Site URL</a> &amp; <a href="https://codex.wordpress.org/Giving_WordPress_Its_Own_Directory" target="_blank">Alternate Directory</a>.  If you're not sure about this value then leave it the same as the new setup URL.</td>
                </tr>
                <tr>

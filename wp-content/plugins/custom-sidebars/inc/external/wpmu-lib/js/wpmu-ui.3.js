 ...
 * @link     https://appendto.com/2010/10/how-good-c-habits-can-encourage-bad-javascript-habits-part-1/
 * @requires jQuery
 */
/*global jQuery:false */
/*global window:false */
 ...
 *
 * @requires underscore.js (https://underscorejs.org/)
 * ----------------------------------------------------------------------------
 *
 * @version  3.0.0
 * @author   Philipp Stracker for WPMU Dev
		...
		function _get_data( action, use_formdata ) {
			...
			if ( _data instanceof jQuery ) {
				...
				if ( use_formdata ) {
					...
					// https://stackoverflow.com/a/8407771/313501
					var push_counters = {},
						patterns = {

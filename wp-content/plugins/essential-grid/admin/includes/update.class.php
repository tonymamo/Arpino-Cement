...
class Essential_Grid_Update {
	...
	private $plugin_url			= 'https://codecanyon.net/item/essential-grid-responsive-wordpress-plugin';
	private $remote_url			= 'https://updates.themepunch.com/check_for_updates.php';
	private $remote_url_info	= 'https://updates.themepunch.com/essential-grid/essential-grid.php';

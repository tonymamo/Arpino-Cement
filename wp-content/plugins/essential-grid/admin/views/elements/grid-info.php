	...
	<div id="tp-validation-box" style="cursor:pointer;border:1px solid #e5e5e5; margin-top:10px;padding:15px 15px 15px 80px; border-radius:0px;-moz-border-radius:0px;-webkit-border-radius:0px;position:relative;overflow:hidden;background:#FFFFFF">		
		...
		<div id="rs-validation-wrapper" style="display:<?php echo $displ; ?>">
			...
			<div class="validation-input">
				...
				<p class="validation-description"><?php _e('Please enter your ', EG_TEXTDOMAIN); ?><strong style="color:#000"><?php _e('CodeCanyon Essential Grid purchase code / license key', EG_TEXTDOMAIN); ?></strong><?php _e('. You can find your key by following the instructions on', EG_TEXTDOMAIN); ?><a target="_blank" href="https://www.themepunch.com/home/plugins/wordpress-plugins/revolution-slider-wordpress/where-to-find-the-purchase-code/"><?php _e(' this page.', EG_TEXTDOMAIN); ?></a></p>
			</div>
			<div class="clear"></div>
		...
		<?php if($validated === 'true') {
			...
			<p>
			<?php _e("Please feel free to contact us via our ", EG_TEXTDOMAIN)?><a href='https://themepunch.ticksy.com'><?php _e("Support Forum ", EG_TEXTDOMAIN)?></a><?php _e("and/or via the ", EG_TEXTDOMAIN)?><a href='https://codecanyon.net/item/tp_eg_pro-responsive-teaser-wordpress-plugin/4720988'><?php _e("Item Disscussion Forum", EG_TEXTDOMAIN)?></a><br />
			</p> 	
			<?php 	
		} else {
			?> 

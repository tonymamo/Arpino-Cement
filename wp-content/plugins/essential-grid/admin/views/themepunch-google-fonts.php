 ...
 */
 ...
 ?>
	...
	<div id="eg-grid-google-font-wrapper">
		...
		?>
		<div>
			<i style="font-size:10px;color:#777"><?php _e('Copy the Google Font Family from <a href="https://www.google.com/fonts" target="_blank">https://www.google.com/fonts</a> like: <strong>Open+Sans:400,700,600</strong>', EG_TEXTDOMAIN); ?></i>
		</div>
	</div>

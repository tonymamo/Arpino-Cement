...
class Essential_Grid {
    ...
    public function output_wrapper_pre($grid_preview = false){
		...
		$do_fix_height = $this->add_start_height_css($grid_id_wrap);
		...
		echo '<article class="myportfolio-container '.$navigation_skin.$fix_height_class.'" id="'.$grid_id_wrap.$css_id.$article_id.'">'."\n\n"; //fullwidthcontainer-with-padding 

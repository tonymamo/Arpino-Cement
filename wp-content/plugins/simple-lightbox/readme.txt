...
Donate link: https://gum.co/slb-donate
License: GPLv2
...
* For more usage tips, go to [Simple Lightbox's official page](https://archetyped.com/tools/simple-lightbox/)
...
Get more information on [Simple Lightbox's official page](https://archetyped.com/tools/simple-lightbox/)

...
<div id="bsr-search-replace-wrap">
	...
	<div class="inside">
		...
		<table id="bsr-search-replace-form" class="form-table">
			...
			<tr>
				<td><label for="replace_guids"><strong><?php _e( 'Replace GUIDs<a href="https://codex.wordpress.org/Changing_The_Site_URL#Important_GUID_Note" target="_blank">?</a>', 'better-search-replace' ); ?></strong></label></td>
				<td>

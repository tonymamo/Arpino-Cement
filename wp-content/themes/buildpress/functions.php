 ...
 *
 * @see https://developer.wordpress.com/themes/content-width/Enqueue
 */
...
if ( ! function_exists( 'buildpress_enqueue_scripts' ) ) {
	function buildpress_enqueue_scripts() {
		...
		$buildpress_main_js_dependencies = array(
			'jquery',
			'underscore',
			'buildpress-gmaps',
		);

		$buildpress_main_js_dependencies = apply_filters( 'buildpress_main_js_dependencies', $buildpress_main_js_dependencies );

		// main JS file
		wp_enqueue_script( 'buildpress-main', get_template_directory_uri() . '/assets/js/main.min.js', $buildpress_main_js_dependencies, BUILDPRESS_WP_VERSION, true );

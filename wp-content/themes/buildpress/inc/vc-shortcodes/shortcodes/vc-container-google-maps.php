			...
			vc_map( array(
				...
				'params'          => array(
					array(
						...
						'description' => sprintf( __( 'Get this from %s (right click on map and select What\'s here?) or %s. Latitude and longitude separated by comma.', 'buildpress_wp' ), '<a href="https://maps.google.com/" target="_blank">Google Maps</a>', '<a href="https://www.findlatitudeandlongitude.com/" target="_blank">this site</a>' ),
						'param_name'  => 'lat_long',

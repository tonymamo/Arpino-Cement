	...
	class PT_Google_Map extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				...
				<small><?php printf( _x( "Get this from %s (right click on map and select What's here?) or %s. Latitude and longitude separated by comma.", 'backend', 'buildpress_wp' ), '<a href="https://maps.google.com/" target="_blank">Google Maps</a>', '<a href="https://www.findlatitudeandlongitude.com/" target="_blank">this site</a>' ); ?></small>

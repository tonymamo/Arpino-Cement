...
function buildpress_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'force_activation'   => true,
			'force_deactivation' => true,
			'external_url'       => 'https://www.advancedcustomfields.com/add-ons/repeater-field/',
		),
		array(
		...
		array(
			...
			'required'           => false,
			'version'            => '2.3.2',
			'external_url'       => 'https://codecanyon.net/item/essential-grid-wordpress-plugin/7563340?ref=ProteusThemes',
		),
		array(

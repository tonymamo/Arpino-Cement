	...
	function buildpress_ocdi_import_files() {
		return array(
			array(
				...
				'import_file_url'            => 'https://artifacts.proteusthemes.com/xml-exports/buildpress-latest.xml',
				'import_widget_file_url'     => 'https://artifacts.proteusthemes.com/json-widgets/buildpress.json',
				'import_customizer_file_url' => 'https://artifacts.proteusthemes.com/customizer-exports/buildpress.dat',
				'import_preview_image_url'   => 'https://artifacts.proteusthemes.com/import-preview-images/buildpress.png',
				'preview_url'                => 'https://demo.proteusthemes.com/buildpress',
			),
			array(
				'import_file_name'           => 'BuildPress Light',
				'import_file_url'            => 'https://artifacts.proteusthemes.com/xml-exports/buildpress-light-latest.xml',
				'import_widget_file_url'     => 'https://artifacts.proteusthemes.com/json-widgets/buildpress-light.json',
				'import_customizer_file_url' => 'https://artifacts.proteusthemes.com/customizer-exports/buildpress-light.dat',
				'import_preview_image_url'   => 'https://artifacts.proteusthemes.com/import-preview-images/buildpress-light.png',
				'preview_url'                => 'https://demo.proteusthemes.com/buildpress-light',
			),
			array(
				'import_file_name'           => 'BuildPress Landscape',
				'import_file_url'            => 'https://artifacts.proteusthemes.com/xml-exports/buildpress-landscape-latest.xml',
				'import_widget_file_url'     => 'https://artifacts.proteusthemes.com/json-widgets/buildpress-landscape.json',
				'import_customizer_file_url' => 'https://artifacts.proteusthemes.com/customizer-exports/buildpress-landscape.dat',
				'import_preview_image_url'   => 'https://artifacts.proteusthemes.com/import-preview-images/buildpress-landscape.jpg',
				'preview_url'                => 'https://demo.proteusthemes.com/buildpress-landscape/',
			),
			array(
				'import_file_name'           => 'BuildPress RTL',
				'import_file_url'            => 'https://artifacts.proteusthemes.com/xml-exports/buildpress-rtl-latest.xml',
				'import_widget_file_url'     => 'https://artifacts.proteusthemes.com/json-widgets/buildpress-rtl.json',
				'import_customizer_file_url' => 'https://artifacts.proteusthemes.com/customizer-exports/buildpress-rtl.dat',
				'import_preview_image_url'   => 'https://artifacts.proteusthemes.com/import-preview-images/buildpress-rtl.jpg',
				'preview_url'                => 'https://demo.proteusthemes.com/buildpress-rtl/',
			),
		);
	}
...
/**
 * Before widgets import action hook for OCDI.
 *
 * @param array $selected_import The predefined import that was selected.
 */
if ( ! function_exists( 'buildpress_ocdi_before_content_import' ) ) {
	function buildpress_ocdi_before_content_import( $selected_import ) {
		if ( 'BuildPress Landscape' === $selected_import['import_file_name'] ) {
			// Fixes the widgets import for top right sidebar.
			set_theme_mod( 'theme_style', 'transparent' );

			esc_html_e( 'Before Content import finished!', 'buildpress_wp' );
		}
	}
	add_action( 'pt-ocdi/before_content_import', 'buildpress_ocdi_before_content_import' );
}
